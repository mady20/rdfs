          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <Card>
              <div className="flex items-center gap-5">
                <div className="text-3xl p-3 bg-primary/10 rounded-2xl text-primary">📄</div>
                <div>
                  <div className="text-sm font-semibold text-on-surface-variant uppercase tracking-wider mb-1">Transactions</div>
                  <div className="text-3xl font-bold text-on-surface">{data?.ownTransactionCount || 0}</div>
                  <div className="text-xs text-on-surface-variant/70 mt-1 font-medium">This month</div>
                </div>
              </div>
            </Card>
          </div>
          ...
          <Card title="Quick Actions">
            <div className="flex flex-col gap-3">
              <Button variant="primary" className="w-full justify-start py-3">
                <span className="mr-3 text-lg">➕</span> Create Transaction
              </Button>
              <Button variant="secondary" className="w-full justify-start py-3">
                <span className="mr-3 text-lg">📋</span> View Ledger
              </Button>
            </div>
          </Card>
